...
Module Module1
    ...
    Sub Main(ByVal args() As String)
        ...
        Try
            If args.Length < 3 Then
                If args.Length = 0 Then
                    Console.WriteLine("VISBO ReportGen: Anzahl Parameter ist nicht korrekt!")
                    Console.WriteLine(" ")
                    Console.WriteLine("1. Parameter: Name of the ReportBatch-Excelfile")
                    Console.WriteLine("2. Parameter: DB-LoginName")
                    Console.WriteLine("3. Parameter: DB-PWD")
                    Console.WriteLine("4. Parameter (optional): Spracheinstellung")
                Else
                    If args(0) = "?" Then
                        Console.WriteLine("1. Parameter: Name of the ReportBatch-Excelfile")
                        Console.WriteLine("2. Parameter: DB-LoginName")
        ...
        Console.WriteLine("Ende - VISBO ReportGen")
