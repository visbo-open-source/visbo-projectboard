...
namespace MongoDbTest
{
    class Program
    {
        ...
        static async Task MainAsync(string[] args) { 
            ...
            var id = r.StoreDocumentToDBAsync(filepath, 1, "pk", new String[]{"pk"}, "desc");
            ...
            Console.WriteLine("document is stored at " + await r.retrieveDocumentFromDBByIdAsync(await id, "pk", path));
