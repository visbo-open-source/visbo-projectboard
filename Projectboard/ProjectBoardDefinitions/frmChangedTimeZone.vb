...
Public Class frmChangedTimeZone
    ...
    Private Sub frmChangedTimeZone_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If awinSettings.englishLanguage Then
            ...
            messageBox.Text = "The following charts only show values based on the latest organization, " & vbCrLf & "valid from: " & tsOfUsedOrga.ToString("MMMM dd, yyyy")
        Else
            messageBox.Text = "In den folgenden Charts werden nur Werte auf Basis der neuesten Organisation angezeigt, " & vbCrLf & "gültig ab: " & tsOfUsedOrga.ToString("dd.MM.yyyy")
