...
Public Class frmChangedTimeZone
    ...
    Private Sub frmChangedTimeZone_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If awinSettings.englishLanguage Then
            ...
            messageBox.Text = "The following charts only show values based on the latest organization, valid from: " & tsOfcurrentOrga.ToString("MMMM dd, yyyy")
        Else
            messageBox.Text = "In den folgenden Charts werden nur Werte auf Basis der neuesten Organisation angezeigt, gültig ab:  " & tsOfcurrentOrga.ToString("dd.MM.yyyy")
