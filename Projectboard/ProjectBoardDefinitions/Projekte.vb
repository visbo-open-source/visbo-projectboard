...
Public Module Projekte
    ...
    ''' <returns></returns>
    Public Function isAmongTopGroup(ByVal rankingList As SortedList(Of Double, Integer), ByVal uid As Integer) As Boolean
    ...
    Public Sub awinExportProjectmitHrchy(hproj As clsProjekt)
        ...
        Try
            With CType(appInstance.ActiveWorkbook.Worksheets("Attribute"), Excel.Worksheet)
                ...
                If Not IsNothing(hproj.vpStatus) Then
                    .Range("Status").Value = hproj.vpStatus
                    rng = .Range("Status")
                    With rng
