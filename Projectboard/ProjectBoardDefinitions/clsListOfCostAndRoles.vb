...
'''' <summary>
'''' gibt die Phasen zurück, die die angegebene Skill enthalten  
'''' </summary>
...
'            Dim skillUID As Integer = skill.UID

'            For Each kvp As KeyValuePair(Of Integer, SortedList(Of Integer, Collection)) In _listOfRoles
'                If kvp.Value.ContainsKey(skillUID) Then
'                    Dim tmpCollection As Collection = kvp.Value.Item(skillUID)
