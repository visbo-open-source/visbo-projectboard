...
Partial Public NotInheritable Class Tabelle7
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Tabelle7", "Tabelle7")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Tabelle7 As Tabelle7

    Friend Shared Property Tabelle7() As Tabelle7
        Get
            Return _Tabelle7
        End Get
        Set(value As Tabelle7)
            If (_Tabelle7 Is Nothing) Then
                _Tabelle7 = value
            Else
