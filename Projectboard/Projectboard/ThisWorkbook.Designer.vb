...
Partial Public NotInheritable Class ThisWorkbook
    ...
    Public WithEvents ActionsPane As Microsoft.Office.Tools.ActionsPane
    ...
    Public WithEvents ThisApplication As Microsoft.Office.Interop.Excel.Application
...
Partial Friend NotInheritable Class Globals
    ...
    Public Shared Property ThisWorkbook() As ThisWorkbook
        Get
    ...
    Public Shared Property Factory() As Global.Microsoft.Office.Tools.Excel.Factory
        Get
            Return _factory
        End Get
    ...
    Public Shared ReadOnly Property Ribbons() As ThisRibbonCollection
        Get
...
<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
 Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.Tools.Office.ProgrammingModel.dll", "11.0.0.0")> _
Partial Public NotInheritable Class ThisRibbonCollection
    Inherits Microsoft.Office.Tools.Ribbon.RibbonCollectionBase

    '''
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Ribbon.RibbonFactory)
        MyBase.New(factory)
    End Sub
End Class
