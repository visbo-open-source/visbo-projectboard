...
Partial Public NotInheritable Class Tabelle1
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Tabelle1", "Tabelle1")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Tabelle1 As Tabelle1

    Friend Shared Property Tabelle1() As Tabelle1
        Get
            Return _Tabelle1
        End Get
        Set(value As Tabelle1)
            If (_Tabelle1 Is Nothing) Then
                _Tabelle1 = value
            Else
