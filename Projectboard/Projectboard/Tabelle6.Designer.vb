...
Partial Public NotInheritable Class Tabelle6
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Tabelle6", "Tabelle6")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Tabelle6 As Tabelle6

    Friend Shared Property Tabelle6() As Tabelle6
        Get
            Return _Tabelle6
        End Get
        Set(value As Tabelle6)
            If (_Tabelle6 Is Nothing) Then
                _Tabelle6 = value
            Else
