...
Partial Public NotInheritable Class Tabelle8
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Tabelle8", "Tabelle8")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Tabelle8 As Tabelle8

    Friend Shared Property Tabelle8() As Tabelle8
        Get
            Return _Tabelle8
        End Get
        Set(value As Tabelle8)
            If (_Tabelle8 Is Nothing) Then
                _Tabelle8 = value
            Else
