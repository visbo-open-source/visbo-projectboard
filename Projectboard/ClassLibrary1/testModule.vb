...
Public Module testModule
                        ...
                        Select Case kennzeichnung
                            ...
                            Case "Soll-Ist1 Gesamtkosten"
                                ...
                                Try
                                    ...
                                    reportObj = Nothing
                                    Call createSollIstOfProject(hproj, reportObj, Date.Now, 3, qualifier, vglBaseline, htop, hleft, hheight, hwidth, True)
                            ...
                            Case "Soll-Ist1 Kostenart"
                                ...
                                Try
                                    ...
                                    reportObj = Nothing
                                    Call createSollIstOfProject(hproj, reportObj, Date.Now, 5, qualifier, vglBaseline, htop, hleft, hheight, hwidth, True)
                    ...
                    Select Case kennzeichnung
                        ...
                        Case "Strategie/Risiko/Marge"
                            ...
                            If qualifier = "Ampel" Then
                                Call awinCreatePortfolioDiagrams(myCollection, obj, False, PTpfdk.FitRisiko, PTpfdk.AmpelFarbe, False, True, True, htop, hleft, hwidth, hheight, True)
                            Else
                                Call awinCreatePortfolioDiagrams(myCollection, obj, False, PTpfdk.FitRisiko, PTpfdk.ProjektFarbe, False, True, True, htop, hleft, hwidth, hheight, True)
                            End If
                        ...
                        Case "Strategie/Risiko/Ausstrahlung"
                            ...
                            If qualifier = "Ampel" Then
                                Call awinCreatePortfolioDiagrams(myCollection, obj, False, PTpfdk.FitRisikoDependency, PTpfdk.AmpelFarbe, False, True, True, htop, hleft, hwidth, hheight, True)
                            Else
                                Call awinCreatePortfolioDiagrams(myCollection, obj, False, PTpfdk.FitRisikoDependency, PTpfdk.ProjektFarbe, False, True, True, htop, hleft, hwidth, hheight, True)
                            End If
                        ...
                        Case "Strategie/Risiko/Volumen"
                            ...
                            Call awinCreatePortfolioDiagrams(myCollection, obj, False, PTpfdk.FitRisikoVol, PTpfdk.ProjektFarbe, False, True, True, htop, hleft, hwidth, hheight, True)
                        ...
                        Case "Zeit/Risiko/Volumen"
                            ...
                            Call awinCreatePortfolioDiagrams(myCollection, obj, False, PTpfdk.ComplexRisiko, PTpfdk.ProjektFarbe, False, True, True, htop, hleft, hwidth, hheight, True)
            ...
            If showNonPrioContainerProjects Then
                ...
                For Each kvp As KeyValuePair(Of String, clsProjekt) In ShowProjekte.Liste
                    ...
                    If Not topPrioProjects.Contains(kvp.Key) Then
                        ...
                        Dim dummyCard As PowerPoint.Shape = createPPTShapeFromShape(pCardDummyShape, pptSlide)
    ...
    '                                            If awinSettings.englishLanguage Then
    '                                                outputline = "No permission to store this project: " & kvp.Value.name & ", " & kvp.Value.variantName
    '                                                outPutCollection.Add(outputline)
    '                                            Else
    '                                                outputline = "Keine Erlaubnis dieses Projekt zu speichern: " & kvp.Value.name & ", " & kvp.Value.variantName
    '                                                outPutCollection.Add(outputline)
    '                                            End If
    ...
    '                                        Case 403  'No Permission to Create Visbo Project Version
    '                                            If awinSettings.englishLanguage Then
    '                                                outputline = "No permission to store this project: " & hproj.name
    '                                                outputCollection.Add(outputline)
    '                                            Else
    '                                                outputline = "Keine Erlaubnis dieses Projekt zu speichern: " & hproj.name
    '                                                outputCollection.Add(outputline)
    '                                            End If
            ...
            If anzZeilen > 1 Then
                ...
                With tabelle
                    ...
                    If Not IsNothing(vglproj) Then
                        ...
                        CType(.Cell(zeile, 3), pptNS.Cell).Shape.TextFrame2.TextRange.Text = tmpStr & vbLf & vglproj.timeStamp.ToString("d", repCult)
                    Else
    ...
    Sub zeichneTrendSymbol(ByVal pptslide As pptNS.Slide, ByVal tabelle As pptNS.Table, ByVal tbZeile As Integer, ByVal tbSpalte As Integer,
        ...
        Dim newZeichen As pptNS.Shape = Nothing


        newZeichen = createPPTShapeFromShape(zeichen, pptslide)

        ' ist der Pfeil größer als die Zelle ? 
        If tabelle.Cell(tbZeile, tbSpalte).Shape.Width < newZeichen.Width Or
             tabelle.Cell(tbZeile, tbSpalte).Shape.Height < newZeichen.Height Then
            ' dann am kleineren orientieren 

            Try
                korrFaktor = System.Math.Min(tabelle.Cell(tbZeile, tbSpalte).Shape.Width / newZeichen.Width, tabelle.Cell(tbZeile, tbSpalte).Shape.Height / newZeichen.Height)
            Catch ex As Exception
    ...
    Sub zeichneTrendSymbol(ByVal pptslide As pptNS.Slide, ByVal tabelle As pptNS.Table, ByVal tbZeile As Integer, ByVal tbSpalte As Integer,
        ...
        Dim korrFaktor As Double = 1.0
        Dim newZeichen As pptNS.ShapeRange = Nothing
            ...
            Else
                With appInstance.Charts.Add
                    ...
                    Do While Not achieved And anzahlVersuche < 10
                        Try
                            'Call Sleep(100)
                            .Location(Where:=Excel.XlChartLocation.xlLocationAsObject, Name:=CType(appInstance.Workbooks.Item(myProjektTafel).Worksheets(arrWsNames(ptTables.MPT)), Excel.Worksheet).Name)
                            achieved = True
                        Catch ex As Exception
                            errmsg = ex.Message
                            'Call Sleep(100)
    ...
    Sub draw3RowsCalendar(ByRef rds As clsPPTShapes, Optional ByVal minCal As Boolean = False)
        ...
        ' Minimum Zeichnen an Kalender-Höhe 
        If minCal Then
            KalenderHoehe = rds.yearVorlagenShape.Height * 1.05
        End If
        ...
        newShape = createPPTShapeFromShape(rds.calendarLineShape, rds.pptSlide)
        With newShape
        ...
        newShape = createPPTShapeFromShape(rds.calendarHeightShape, rds.pptSlide)
        With newShape
            .Left = rds.calendarLineShape.Left
            .Top = rds.calendarLineShape.Top - (KalenderHoehe + rds.calendarLineShape.Height / 2)
        ...
        ' das muss auch bei minCAL gemacht werden 
        ...
        Do While curDatePtr <= rds.PPTEndOFCalendar
            ...
            newShape = createPPTShapeFromShape(rds.calendarStepShape, rds.pptSlide)
            With newShape
                .Left = curRight
                .Top = curTop
                .Height = rowHeight
            ...
            If curRight - curLeft >= rds.yearVorlagenShape.Width Then
                ...
                newShape = createPPTShapeFromShape(rds.yearVorlagenShape, rds.pptSlide)
                With newShape
        ...
        If Not minCal Then
            ...
            Do While curDatePtr <= rds.PPTEndOFCalendar
                ...
                If beschrifteLevel2 Then
                    ...
                    newShape = createPPTShapeFromShape(rds.quarterMonthVorlagenShape, rds.pptSlide)
                    With newShape
        ...
        ' das wird wieder auf jeden Fall gemacht , bei minCal wie bei normalem 3-reihigem Kalender
        ...
        If showRangeLeft > 0 And showRangeRight >= showRangeLeft Then
            ...
            If Not IsNothing(rds.calendarMarkShape) Then
                ...
                newShape = createPPTShapeFromShape(rds.calendarMarkShape, rds.pptSlide)
                With newShape
                    .Left = rds.calendarLineShape.Left +
        ...
        If awinSettings.mppVertikalesRaster And
            ...
            newShape = createPPTShapeFromShape(rds.calendarQuartalSeparator, rds.pptSlide)
            ...
            For i As Integer = 0 To positionYPtr - 1
                ...
                newShape = createPPTShapeFromShape(rds.calendarYearSeparator, rds.pptSlide)
                With newShape
                    .Left = positionY(i)
                    .Top = rds.calendarLineShape.Top
                    .Height = rds.drawingAreaBottom - rds.calendarLineShape.Top
        ...
        If Not IsNothing(rds.todayLineShape) And
            Date.Now.Date >= rds.PPTStartOFCalendar And
            Date.Now.Date <= rds.PPTEndOFCalendar Then


            newShape = createPPTShapeFromShape(rds.todayLineShape, rds.pptSlide)
            With newShape
                .Left = rds.calendarLineShape.Left +
    ...
    Sub zeichneSwimlaneOfProject(ByRef rds As clsPPTShapes, ByRef curYPosition As Double,
        ...
        Dim swlNameShape As pptNS.Shape = copiedShape
        ' Ergänzung 19.4.16
    ...
    Sub zeichnePPTProjects(ByRef pptslide As pptNS.Slide, ByRef projectCollection As SortedList(Of Double, String),
        ...
        ' tk 29.12 wird nicht mehr unterstütt
        ...
        For currentProjektIndex = startIX To projectsToDraw
            ...
            If AlleProjekte.Containskey(fullName) Then
                ...
                ' tk 29.12.20 wird nicht mehr unterstützt
                ...
                ' tk 29.12.20 mehrere Projekte in einer Zeile wird nicht mehr unterstützt
                ...
                copiedShape = createPPTShapeFromShape(rds.projectNameVorlagenShape, pptslide)
                With copiedShape
                ...
                Dim projectNameShape As pptNS.Shape = copiedShape
                ...
                If awinSettings.mppShowAmpel And Not IsNothing(rds.ampelVorlagenShape) Then
                    ...
                    copiedShape = createPPTShapeFromShape(rds.ampelVorlagenShape, pptslide)
                    With copiedShape
                ...
                If awinSettings.mppShowProjectLine Then
                    ...
                    copiedShape = createPPTShapeFromShape(rds.projectVorlagenShape, pptslide)
                    With copiedShape
                ...
                If drawBUShape Then
                    ...
                    copiedShape = createPPTShapeFromShape(rds.buColorShape, pptslide)
                    With copiedShape
                        .Top = CSng(startedAtYPos)
                ...
                If drawRowDifferentiator And toggleRowDifferentiator Then
                    ...
                    copiedShape = createPPTShapeFromShape(rds.rowDifferentiatorShape, pptslide)
                    With copiedShape
                        .Top = CSng(startedAtYPos)
                        .Left = CSng(rds.projectListLeft)
                        '''''.Height = hproj.calcNeededLines(selectedPhases, awinSettings.mppExtendedMode, Not awinSettings.mppShowAllIfOne) * zeilenhoehe
    ...
    '                                copiedShape = createPPTShapeFromShape(rds.PhDescVorlagenShape, pptslide)
    '                                With copiedShape
    ...
    '                                copiedShape = createPPTShapeFromShape(rds.PhDateVorlagenShape, pptslide)
    '                                With copiedShape
    ...
    '                                copiedShape = createPPTShapeFromShape(rds.phaseDelimiterShape, pptslide)
    '                                With copiedShape
    ...
    '                copiedShape = createPPTShapeFromShape(rds.durationArrowShape, pptslide)
    ...
    '                copiedShape = createPPTShapeFromShape(rds.durationTextShape, pptslide)
    ...
    Public Sub zeichneSwlSegmentinAktZeile(ByRef rds As clsPPTShapes, ByRef curYPosition As Double, ByVal segmentPhaseID As String,
        ...
        copiedShape = createPPTShapeFromShape(rds.segmentVorlagenShape, rds.pptSlide)
    ...
    ''' YPosition represents the "Null-Linie"
    ''' </summary>
    ''' <param name="rds"></param>
    ...
    ''' <param name="yPosition"></param>
    ''' <remarks></remarks>
    Public Sub zeichnePhaseinSwimlane(ByRef rds As clsPPTShapes, ByRef shapeNames As Collection,
                                           ByVal hproj As clsProjekt,
    ...
    ''' <remarks></remarks>
    Private Sub zeichneMultiprojektSicht(ByRef pptApp As pptNS.Application, ByRef pptCurrentPresentation As pptNS.Presentation, ByRef pptslide As pptNS.Slide,
                                             ByRef objectsToDo As Integer, ByRef objectsDone As Integer, ByRef pptFirstTime As Boolean,
        ...
        Dim errorShape As pptNS.Shape = Nothing
        ...
        ElseIf Not IsNothing(rds.errorVorlagenShape) Then
            ...
            errorShape = createPPTShapeFromShape(rds.errorVorlagenShape, pptslide)
            With errorShape
    ...
    ''' <remarks></remarks>
    Private Sub zeichneSwimlane2Sicht(ByRef pptApp As pptNS.Application, ByRef pptCurrentPresentation As pptNS.Presentation, ByRef pptslide As pptNS.Slide,
                                                 ByRef swimLanesToDo As Integer, ByRef swimLanesDone As Integer, ByRef pptFirstTime As Boolean,
    ...
    ''' <param name="kennzeichnung"></param>
    ''' <remarks></remarks>
    Private Sub zeichneCategorySwimlaneSicht(ByRef pptApp As pptNS.Application, ByRef pptCurrentPresentation As pptNS.Presentation, ByRef pptslide As pptNS.Slide,
                                                 ByRef swimLanesToDo As Integer, ByRef swimLanesDone As Integer, ByRef pptFirstTime As Boolean,
                                                 ByRef zeilenhoehe As Double, ByRef legendFontSize As Double,
                                                 ByVal selectedPhases As Collection, ByVal selectedMilestones As Collection,
                                                 ByVal selectedRoles As Collection, ByVal selectedCosts As Collection,
        ...
        If missingShapes.Length = 0 Then
            ...
            Do While (curSwimlaneIndex <= swimLanesToDo) And
                ...
                Call zeichneCategoryOfProject(rds, curYPosition, toggleRow,
                                              hproj, categoryToDraw, considerAll,
                                              considerZeitraum, zeitraumGrenzeL, zeitraumGrenzeR,
                                              selectedPhaseIDs, selectedMilestoneIDs,
                                              selectedRoles, selectedCosts,
                                              swimLaneZeilen)
    ...
    ''' <param name="pptSlide"></param>
    ''' <returns></returns>
    Public Function createPPTShapeFromShape(ByVal srcShape As pptNS.Shape, ByVal pptSlide As pptNS.Slide) As pptNS.Shape

        Dim newShape As pptNS.Shape = Nothing

        Try
            If srcShape.AutoShapeType <> MsoShapeType.msoShapeTypeMixed And Not srcShape.Type = MsoShapeType.msoTextBox Then
                newShape = pptSlide.Shapes.AddShape(srcShape.AutoShapeType, srcShape.Left, srcShape.Top, srcShape.Width, srcShape.Height)

                srcShape.PickUp()
                newShape.Apply()

            ElseIf srcShape.Type = MsoShapeType.msoLine Then

                Dim isHorizontal As Boolean = srcShape.Width > srcShape.Height

                Dim beginX As Single = srcShape.Left
                Dim beginY As Single = srcShape.Top

                Dim endX As Single
                Dim endY As Single

                If isHorizontal Then
                    endX = beginX + srcShape.Width
                    endY = beginY
                Else
                    endX = beginX
                    endY = beginY + srcShape.Height
                End If

                newShape = pptSlide.Shapes.AddLine(beginX, beginY, endX, endY)

                With newShape
                    .Line.ForeColor = srcShape.Line.ForeColor
                    ...
                    .Line.BackColor = srcShape.Line.BackColor
                End With

            ElseIf srcShape.Type = MsoShapeType.msoTextBox Then
                newShape = pptSlide.Shapes.AddTextbox(Microsoft.Office.Core.MsoTextOrientation.msoTextOrientationHorizontal, 50, 10, 50, 10)

                With newShape
                    .TextFrame2.TextRange.Text = "xy"
                    .TextFrame2.MarginLeft = srcShape.TextFrame2.MarginLeft
                    .TextFrame2.MarginRight = srcShape.TextFrame2.MarginRight
                    .TextFrame2.MarginBottom = srcShape.TextFrame2.MarginBottom
                    .TextFrame2.MarginTop = srcShape.TextFrame2.MarginTop
                    .TextFrame2.TextRange.ParagraphFormat.Alignment = srcShape.TextFrame2.TextRange.ParagraphFormat.Alignment
                    .TextFrame2.VerticalAnchor = srcShape.TextFrame2.VerticalAnchor
                    .TextFrame2.WordWrap = srcShape.TextFrame2.WordWrap
                    .TextFrame2.TextRange.Font.Size = srcShape.TextFrame2.TextRange.Font.Size
                    .TextFrame2.TextRange.Font.Name = srcShape.TextFrame2.TextRange.Font.Name
                    .TextFrame2.TextRange.Font.Italic = srcShape.TextFrame2.TextRange.Font.Italic
                    .TextFrame2.TextRange.Font.Bold = srcShape.TextFrame2.TextRange.Font.Bold
                    .TextFrame2.TextRange.Font.Fill.BackColor = srcShape.TextFrame2.TextRange.Font.Fill.BackColor
                    .TextFrame2.TextRange.Font.Fill.ForeColor = srcShape.TextFrame2.TextRange.Font.Fill.ForeColor
                End With
        ...
        createPPTShapeFromShape = newShape
    End Function
