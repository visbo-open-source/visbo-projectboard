...
Partial Public NotInheritable Class Tabelle2
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Tabelle2", "Tabelle2")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Tabelle2 As Tabelle2
    
    Friend Shared Property Tabelle2() As Tabelle2
        Get
            Return _Tabelle2
        End Get
        Set
            If (_Tabelle2 Is Nothing) Then
                _Tabelle2 = value
            Else
